<template>
	<el-row class="container">
		...
		<el-col :span="5" class="right">
				...
				<el-col :span="24">
					<div style="margin-left: 16px; margin-top: 16px; font-weight: bold">
						...
						<el-tooltip
							class="box-item"
							effect="light"
							content="出于个人隐私保护，您上传的照片无法被其它人看到，同时您可以在生成图像后及时删除上传的图片。"
							placement="top"
						>
							<el-icon>
								<InfoFilled />
				...
				<el-col :span="24" class="upload-container">
					<el-row style="height: 100%; align-items: center">
						<el-col :span="16" class="des" style="display: flex; flex-direction: column; align-items: center">
							<div>
								<div>上传参考图(选填)</div>
								<div style="font-size: 12px; margin-top: 8px">支持JPG、PNG、10M以内</div>
							</div>
						</el-col>
						<el-col :span="8">
			...
			<el-row>
				<div style="margin-left: 16px; margin-top: 16px; font-weight: bold">
					...
					<el-tooltip
						class="box-item"
						effect="light"
						content="生成&变换图片消耗2点额度。放大图片消耗1点额度。邀请新用户奖励5点额度。"
						placement="top"
					>
						<el-icon>
							<InfoFilled />
			...
			<el-row>
				<div style="margin-left: 16px; margin-top: 16px; font-weight: bold">高级配置</div>
			</el-row>
			<el-row style="padding: 16px">
		...
		<el-col :span="3" class="right" style="height: 100%">
			<el-row style="justify-content: center; border-bottom: 1px solid var(--el-border-color); height: 100%">
				<div style="font-size: 20px; font-weight: bold; line-height: 50px">艺术风格集锦</div>
				<el-scrollbar style="height: calc(100% - 50px)">
					<div
						v-for="(item, index) in artImages"
						class="image-box"
						:class="mainInput.split(',').indexOf(artImages[index].keywords) != -1 ? 'active-image' : ''"
